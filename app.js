...
var $author$project$Main$StationClicked = function (a) {
	return {$: 1, a: a};
};
var $author$project$Main$StationsLoaded = function (a) {
	return {$: 0, a: a};
};
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $author$project$Main$dataError = _Platform_incomingPort('dataError', $elm$json$Json$Decode$string);
var $elm$json$Json$Decode$value = _Json_decodeValue;
var $author$project$Main$stationClicked = _Platform_incomingPort('stationClicked', $elm$json$Json$Decode$value);
var $author$project$Main$stationsLoaded = _Platform_incomingPort('stationsLoaded', $elm$json$Json$Decode$value);
var $author$project$Main$subscriptions = function (_v0) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				$author$project$Main$stationsLoaded($author$project$Main$StationsLoaded),
				$author$project$Main$stationClicked($author$project$Main$StationClicked),
				$author$project$Main$dataError($author$project$Main$DataError)
			]));
};
...
var $author$project$Main$locateMe = _Platform_outgoingPort(
	'locateMe',
	function ($) {
		return $elm$json$Json$Encode$null;
	});
...
var $author$project$Main$Station = function (id) {
...
var $author$project$Main$stationsMetaDecoder = A3(
	$elm$json$Json$Decode$map2,
	$author$project$Main$StationsMeta,
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
				var value = msg.a;
				var _v1 = A2($elm$json$Json$Decode$decodeValue, $author$project$Main$stationsMetaDecoder, value);
				if (!_v1.$) {
					var meta = _v1.a;
					return _Utils_Tuple2(
						_Utils_update(
			...
			case 1:
				var value = msg.a;
				var _v2 = A2($elm$json$Json$Decode$decodeValue, $author$project$Main$stationDecoder, value);
				if (!_v2.$) {
					var station = _v2.a;
					return _Utils_Tuple2(
						_Utils_update(
			...
			case 6:
				return _Utils_Tuple2(
					model,
					$author$project$Main$locateMe(0));
			default:
				var errMsg = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
...
var $author$project$Main$CloseAbout = {$: 4};
...
var $author$project$Main$stopPropagationClick = A2(
...
var $author$project$About$view = A2(
	$elm$html$Html$div,
	_List_Nil,
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$text('⚡ Stromfinder')
				])),
			A2(
			$elm$html$Html$p,
			_List_Nil,
			_List_fromArray(
				[
					$elm$html$Html$text('Interaktive Karte aller Ladesäulen in Deutschland.')
				])),
			A2(
			$elm$html$Html$p,
			_List_Nil,
			_List_fromArray(
				[
					$elm$html$Html$text('Hier findest du über 70.000 öffentlich zugängliche Ladestationen auf einen Blick – mit allen Details zu Steckertypen, Leistung, Öffnungszeiten und Betreibern.')
				])),
			A2(
			$elm$html$Html$h2,
			_List_Nil,
				...
				[
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$text(' – Alle Ladestationen auf einer OpenStreetMap-Karte mit Marker-Clustering')
						])),
					A2(
					$elm$html$Html$li,
					_List_Nil,
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text('Detailansicht')
								])),
							$elm$html$Html$text(' – Klicke auf eine Station für Adresse, Ladepunkte, Steckertypen und Leistung')
						])),
					A2(
					$elm$html$Html$li,
					_List_Nil,
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text('Schnell- & Normallader')
								])),
							$elm$html$Html$text(' – Farblich unterschieden: 🟠 Schnelllader / 🟢 Normallader')
						])),
					A2(
					$elm$html$Html$li,
					_List_Nil,
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text('Mobil & Desktop')
								])),
							$elm$html$Html$text(' – Responsive Design, als App installierbar (PWA)')
						])),
					A2(
					$elm$html$Html$li,
					_List_Nil,
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text('Wöchentlich aktualisiert')
								])),
							$elm$html$Html$text(' – Die Daten werden automatisch erneuert')
						]))
				])),
			A2(
			$elm$html$Html$h2,
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Datenquelle')
				])),
			A2(
			$elm$html$Html$p,
			_List_Nil,
			_List_fromArray(
				[
					$elm$html$Html$text('Die Daten stammen aus dem offiziellen '),
					A2(
					$elm$html$Html$a,
					_List_fromArray(
						[
							$elm$html$Html$Attributes$href('https://www.bundesnetzagentur.de/DE/Fachthemen/ElektrizitaetundGas/E-Mobilitaet/start.html')
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('Ladesäulenregister der Bundesnetzagentur')
						])),
					$elm$html$Html$text('.')
				])),
			A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Das Schwesterprojekt '),
					A2(
					$elm$html$Html$a,
					_List_fromArray(
						[
							$elm$html$Html$Attributes$href('https://github.com/ratopi/ladesaeule')
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('ratopi/ladesaeule')
						])),
					$elm$html$Html$text(' lädt die CSV-Datei der Bundesnetzagentur herunter, wandelt sie nach JSON und veröffentlicht das Ergebnis als komprimierte Datei auf GitHub Pages. Stromfinder lädt diese Datei und zeigt die Stationen auf der Karte.')
				])),
			A2(
			$elm$html$Html$h2,
			_List_Nil,
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Stromfinder ist Open Source unter der '),
					A2(
					$elm$html$Html$strong,
					_List_Nil,
					_List_fromArray(
						[
							$elm$html$Html$text('Apache License 2.0')
						])),
					$elm$html$Html$text('.')
				])),
			A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Quellcode: '),
					A2(
					$elm$html$Html$a,
					_List_fromArray(
						[
							$elm$html$Html$Attributes$href('https://github.com/ratopi/stromfinder')
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('github.com/ratopi/stromfinder')
						]))
				])),
			A2(
			$elm$html$Html$p,
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Fehler gefunden? → '),
					A2(
					$elm$html$Html$a,
					_List_fromArray(
						[
							$elm$html$Html$Attributes$href('https://github.com/ratopi/stromfinder/issues')
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('Issue melden')
						]))
				]))
		]));
var $author$project$Main$viewAboutOverlay = function (model) {
	return model.D ? A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$id('about-overlay'),
				$elm$html$Html$Events$onClick($author$project$Main$CloseAbout)
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$id('about-modal'),
						$author$project$Main$stopPropagationClick
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$id('about-close'),
								$elm$html$Html$Events$onClick($author$project$Main$CloseAbout),
								$elm$html$Html$Attributes$title('Schließen')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('✕')
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$id('about-content')
							]),
						_List_fromArray(
							[$author$project$About$view]))
					]))
			])) : A2(
		$elm$html$Html$div,
		_List_fromArray(
...
var $author$project$Main$ToggleAbout = {$: 3};
var $author$project$Main$bugsUrl = function (hash) {
	return (hash === '') ? 'https://github.com/ratopi/stromfinder/issues' : ('https://github.com/ratopi/stromfinder/issues/new?body=Version%3A%20' + (hash + '%0A%0A**Beschreibung%3A**%0A'));
};
...
var $author$project$Main$githubIcon = A3(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					A2($elm$html$Html$Attributes$attribute, 'd', 'M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27s1.36.09 2 .27c1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.01 8.01 0 0 0 16 8c0-4.42-3.58-8-8-8z')
				]),
			_List_Nil)
		]));
...
var $author$project$Main$viewVersion = function (hash) {
	if (hash === '') {
		return $elm$html$Html$text('');
	} else {
		var _short = A2($elm$core$String$left, 7, hash);
		return A2(
			$elm$html$Html$a,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$id('version'),
					$elm$html$Html$Attributes$href('https://github.com/ratopi/stromfinder/commit/' + hash),
					$elm$html$Html$Attributes$target('_blank'),
					$elm$html$Html$Attributes$rel('noopener'),
					$elm$html$Html$Attributes$title('Commit ' + hash)
				]),
			_List_fromArray(
				[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('⚡ Stromfinder'),
						$author$project$Main$viewVersion(model.N)
					])),
				A2(
				$elm$html$Html$span,
				_List_fromArray(
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						$author$project$Main$statusText(model))
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$id('header-links')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$id('bugs-link'),
								$elm$html$Html$Attributes$href(
								$author$project$Main$bugsUrl(model.N)),
								$elm$html$Html$Attributes$target('_blank'),
								$elm$html$Html$Attributes$rel('noopener'),
								$elm$html$Html$Attributes$title('Bugs melden')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('🐛 Bugs')
							])),
						A2(
						$elm$html$Html$a,
						_List_fromArray(
							[
								...
								$elm$html$Html$Attributes$target('_blank'),
								$elm$html$Html$Attributes$rel('noopener'),
								$elm$html$Html$Attributes$title('Quellcode auf GitHub')
							]),
						_List_fromArray(
							[
								$author$project$Main$githubIcon,
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$id('about-btn'),
								$elm$html$Html$Events$onClick($author$project$Main$ToggleAbout),
								$elm$html$Html$Attributes$title('Über Stromfinder')
							]),
						_List_fromArray(
							[
								A2(
...
var $author$project$Main$CloseInfoPanel = {$: 2};
...
var $author$project$Main$tableRow = F2(
	function (label, value) {
		return (value !== '') ? $elm$core$Maybe$Just(
			A2(
				$elm$html$Html$tr,
				_List_Nil,
				_List_fromArray(
...
var $author$project$Main$viewChargingPoint = F2(
	function (idx, point) {
		...
		return A2(
			$elm$html$Html$table,
			_List_Nil,
			A2($elm$core$List$filterMap, $elm$core$Basics$identity, rows));
	});
var $author$project$Main$viewChargingPoints = function (points) {
	return $elm$core$List$isEmpty(points) ? _List_Nil : _Utils_ap(
		_List_fromArray(
			[
				A2(
				$elm$html$Html$div,
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						'Ladepunkte (' + ($elm$core$String$fromInt(
...
var $author$project$Main$viewStationDetail = function (s) {
	...
	var openingSection = function () {
		...
		return $elm$core$List$isEmpty(rows) ? _List_Nil : _List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Öffnungszeiten')
					])),
	...
	var addressSection = $elm$core$List$isEmpty(addressRows) ? _List_Nil : _List_fromArray(
		[
			...
			A2($elm$html$Html$table, _List_Nil, addressRows)
		]);
	return _Utils_ap(
		_List_fromArray(
			[
				...
				_Utils_ap(
					...
					_Utils_ap(
						...
						_Utils_ap(
							...
							_Utils_ap(
								paymentSection,
								_Utils_ap(openingSection, idSection))))))));
};
var $author$project$Main$viewInfoPanel = function (maybeStation) {
	if (maybeStation.$ === 1) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$id('info-panel'),
					$elm$html$Html$Attributes$class('hidden')
				]),
			_List_Nil);
	} else {
		var station = maybeStation.a;
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$id('info-close'),
							$elm$html$Html$Events$onClick($author$project$Main$CloseInfoPanel),
							$elm$html$Html$Attributes$title('Schließen')
						]),
					_List_fromArray(
						[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$id('info-content')
						]),
					$author$project$Main$viewStationDetail(station))
				]));
	}
};
...
var $author$project$Main$main = $elm$browser$Browser$element(
	{a7: $author$project$Main$init, bj: $author$project$Main$subscriptions, bm: $author$project$Main$update, bn: $author$project$Main$view});
